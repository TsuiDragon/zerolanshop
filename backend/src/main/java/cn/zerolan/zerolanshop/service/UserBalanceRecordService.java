...
public class UserBalanceRecordService {
    ...
    public UserBalanceRecordService(UserBalanceRecordMapper userBalanceRecordMapper) {
    ...
    public void record(User user, String type, BigDecimal beforeBalance, BigDecimal changeAmount, BigDecimal afterBalance, String orderNo, String remark) {
        if (user == null || user.getId() == null) {
            throw new RuntimeException("Balance record user is required");
        }
    ...
    private String normalizeType(String type) {
        ...
        if (!SUPPORTED_TYPES.contains(normalized)) {
            throw new RuntimeException("Unsupported balance record type");
        }
        return normalized;
    }
