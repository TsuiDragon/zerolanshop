...
CREATE TABLE IF NOT EXISTS `user` (
    ...
    `security_deposit` DECIMAL(10,2) NOT NULL DEFAULT '0.00' COMMENT '保证金',
    `credit_rating` VARCHAR(20) DEFAULT 'A' COMMENT '授信评级',
...
CREATE TABLE IF NOT EXISTS `product` (
    ...
    `terminal_limit_price` DECIMAL(10,2) DEFAULT NULL COMMENT '终端限价',
